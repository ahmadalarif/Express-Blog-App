...
/**
 * Action:      INDEX WITH EJS VIEW
 * Method:      GET
 * URI:         /api/articles
 * Description: Get All Articles
 */
router.get('/articles', function(req, res){
  //res.render('../app/views/articles.ejs');

  Article.find()
  // Return all Articles as an Array
  .then(function(articles) {
    //console.log(articles);
    res.render('../app/views/articles.ejs', {data: articles});
  })
...
router.get('/createArticle', function(req, res){
  res.render('../app/views/createArticle.ejs');
})
